...
async def answer(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(ask_openAI(update.message.text), parse_mode=constants.ParseMode.MARKDOWN_V2)
...
async def photo_answer(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(ask_openAI(question), parse_mode=constants.ParseMode.MARKDOWN_V2)
